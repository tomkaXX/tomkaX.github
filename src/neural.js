define(['./src/Loaders.js', './src/ImageLoader_Overwrite.js'], function (_Loaders) {
  'use strict';
  ...
  Promise.all([Loaders.CacheJSON('events.json')]).then(function () {
    ...
    for (var i in categories) {
      idToCategories[categories[i].id] = categories[i];
    }
    ...
    function yo() {
      return Loaders.CacheJSON("./neuralNet.json").then(function (data) {
